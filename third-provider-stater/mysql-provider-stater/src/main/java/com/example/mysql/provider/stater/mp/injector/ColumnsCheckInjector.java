package com.example.mysql.provider.stater.mp.injector;
...
import com.example.mysql.provider.stater.mp.injector.instances.DataBaseEngine;
import com.example.mysql.provider.stater.mp.injector.instances.MySQLEngine;
import com.example.mysql.provider.stater.mp.injector.instances.PostgreSQLEngine;
...
//                .add(new DeleteByMap());
    ...
    private List<DataSource> getOriginDataSources(DataSource proxyDataSource) {
        ...
        //获取动态数据源
        return new ArrayList<>(dynamicRoutingDataSource.getCurrentDataSources().values());
    }
