package com.example.mysql.provider.stater.mp.service.impl;
...
public class BaseServiceImpl<M extends BaseMapper<T>, T extends BaseConvert> extends ServiceImpl<M, T> implements BaseService<T> {
     ...
     * @param throwEx
     * @return
     * @see ServiceImpl#getOne(Wrapper, boolean)
    ...
    public T getOne(Wrapper<T> queryWrapper, boolean throwEx) {
        ...
        if (queryWrapper instanceof AbstractWrapper<T, ?, ?> wrapper && throwEx) {
