...
public class ApiInterceptor implements HandlerInterceptor {
    ...
    private void setPathAttribute(HttpServletRequest request, HandlerMethod handlerMethod) {
        ...
        request.setAttribute(RequestCons.REQ_SERVER_NAME, ApplicationUtils.getWebServers().shortName());
        request.setAttribute(RequestCons.REQ_ENVIRONMENT, ApplicationUtils.getEnvironment().getEnvironmentStr());
    }
